<template>
  <main>
    <section v-if="people.length === 0" className="container">
      <h3>{{ people.length }} Birthdays Today</h3>
      <button @click="loadPeole">Refresh</button>
    </section>
    <section v-else className="container">
      <h3>{{ people.length }} Birthdays Today</h3>
      <List :people="people" />
      <button @click="clearPeople">Clear all</button>
    </section>
  </main>
</template>
